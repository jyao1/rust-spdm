...
fn fuzz_send_receive_spdm_version(fuzzdata: &[u8]) {
    ...
    let message_c = &[
        17, 131, 0, 0, 114, 253, 55, 144, 110, 247, 139, 83, 136, 40, 149, 104, 113, 194, 2, 22,
        191, 7, 192, 72, 77, 158, 31, 61, 47, 73, 44, 199, 61, 221, 1, 140, 17, 3, 0, 1, 40, 175,
        112, 39, 188, 45, 149, 181, 160, 228, 38, 4, 197, 140, 92, 60, 191, 162, 200, 36, 166, 48,
        202, 47, 15, 74, 121, 53, 87, 251, 57, 59, 221, 138, 200, 138, 146, 216, 163, 112, 23, 18,
        131, 155, 102, 225, 58, 58, 60, 181, 115, 176, 250, 159, 239, 142, 82, 249, 248, 231, 190,
        214, 64, 135, 171, 194, 175, 1, 76, 160, 220, 165, 118, 189, 18, 65, 50, 33, 212, 203, 0,
        0,
    ];

    let message_m = &[17, 224, 0, 0, 17, 96, 0, 1, 0, 0, 0, 0, 0, 0];
    ...
    requester.send_receive_spdm_key_exchange(0, SpdmMeasurementSummaryHashType::SpdmMeasurementSummaryHashTypeNone).unwrap();
}

fn main() {

    fuzz_send_receive_spdm_version(&[1,2,3]);
}
